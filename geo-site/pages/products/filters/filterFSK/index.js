...
export default function FilterFSK() {
    return(
        <PMenu>
            ...
            <h2>Фильтр скважинный щелевой на трубном каркасе, тип ФС-К</h2>
            <img src="/images/product/filters/filterFSK/FilterFSK1.png" className="filter_image" alt="fsk1"/>
            <p>Фильтр скважинный щелевой на трубном каркасе, тип ФС-К состоит из перфорированной обсадной или насосно-компрессорной трубы и фильтрующего элемента, представляющего собой нержавеющую сварную конструкцию, состоящую из несущих опорных колосников с обмоткой профилированным, клиновидным (треугольным) профилем намотанным по спирали вокруг опорных колосников, соединенных методом точечной сварки во всех местах контакта. В результате образуется многоярусный цилиндр, при этом имеющий одно непрерывное отверстие, которое идет по спирали вдоль всей его длины.</p>
