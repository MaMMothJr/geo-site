...
export default function FilterFSP() {
    return(
        <PMenu>
            ...
            <h2>Фильтр скважинный перфорированный, тип ФС-П</h2>
            <img src="/images/product/filters/filterFSP/FilterFSP1.png" className="filter_image" alt="fsp1"/>
            <p>Фильтр скважинный перфорированный, тип ФС-П представляет собой перфорированную насосно-компрессорную или обсадную трубу.</p>
